var kpiScrapSummaryChart2 = function(){
	var months = []; 
	var chart_month;
	function init(curYear){
		//渲染chart1部分
		$.get(manager.root+"/views/tpl/kpi/kpiScrapSummaryChart2.html", function (template) {
			var ractive = new Ractive({
				...
				oncomplete: function(){
					...
					$.ajax({
						url		: manager.root + '/report/scrap/monthlyScrapSummaryChart',
						type	: 'GET',
						dataType:"json",
