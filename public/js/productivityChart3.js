var productivityChart3 = function(){
	var dayList; 
	var targetList; 
	var actualList;
	...
	function init(lineName, curYear, curMonth){
	   //渲染chart3部分
	   $.get(manager.root+"/views/tpl/kpi/productivityChart3.html", function (template) {
	        var ractive4 = new Ractive({
	            ...
	            oncomplete: function(){
	            	...
	            	$.ajax({
	        			url		: manager.root + '/report/productivity/dailyProductivityChart',
	        			type	: 'GET',
	        			dataType:"json",
